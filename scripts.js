...
const JSONBIN_API_KEY = '$2a$10$k3Azgymetcbdjz9ZRZ84T.v4xE3y5./6WEosHOGxP5LZHOLwQf6/i';
const JSONBIN_BIN_ID = '68f2b336d0ea881f40a8bce2';
const CLOUDINARY_CLOUD_NAME = 'docfeepkt';
...
const specialties = [
  { name: 'Critical Care Nursing', description: 'Cares for patients with life-threatening conditions in ICUs.', video: 'https://www.youtube.com/watch?v=uXN_1dAPwUg' },
  { name: 'Pediatric Nursing', description: 'Provides specialized care for children and adolescents.', video: 'https://www.youtube.com/watch?v=HMqoMuKpIPk' },
  { name: 'Oncology Nursing', description: 'Supports cancer patients through treatment and recovery.', video: 'https://www.youtube.com/watch?v=xZ1r8e3eM7U' },
  { name: 'Geriatric Nursing', description: 'Focuses on elderly patients with chronic conditions.', video: 'https://www.youtube.com/watch?v=VN9ZOfAj8gI' },
  { name: 'Emergency Nursing', description: 'Manages urgent cases in fast-paced emergency departments.', video: 'https://www.youtube.com/watch?v=eaa8R3V03Sw' },
  { name: 'Surgical Nursing', description: 'Assists in surgical procedures and post-operative care.', video: 'https://www.youtube.com/watch?v=9aNKPZfyJzE' },
  { name: 'Neonatal Nursing', description: 'Cares for newborns, especially premature infants.', video: 'https://www.youtube.com/watch?v=rsnNaUz5xKw' },
  { name: 'Psychiatric Nursing', description: 'Supports patients with mental health disorders.', video: 'https://www.youtube.com/watch?v=ZsEyrOWH6Mk' },
  { name: 'Cardiac Nursing', description: 'Specializes in patients with heart-related conditions.', video: 'https://www.youtube.com/watch?v=b5VPo_qwL6I' },
  { name: 'Orthopedic Nursing', description: 'Cares for patients with musculoskeletal injuries.', video: 'https://www.youtube.com/watch?v=dOPemoiWDgE' },
